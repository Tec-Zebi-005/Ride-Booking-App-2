...
public class UserDatabase {
    ...
    public static boolean registerPassenger(String username, String password,
        ...
        String insertPassenger = "INSERT INTO Passengers (UserID, Username) VALUES (?, ?)";
        ...
        try (Connection conn = DatabaseConnection.getConnection()) {
            ...
            if (rs.next()) {
                ...
                ps2.setInt(1, userID);
                ps2.setString(2, username); // ← pass username
                ps2.executeUpdate();
            }
    ...
    public static boolean registerDriver(String username, String password,
        ...
        String insertUser = "INSERT INTO Users (Username, PasswordHash, Email, Phone, Role) " +
                "VALUES (?, ?, ?, ?, 'Driver')";
        // ← Added Username column
        String insertDriver = "INSERT INTO Drivers (UserID, Username, LicenseNumber, VehicleType) " +
                "VALUES (?, ?, ?, ?)";
