    ...
    private JPanel createRideCard(RideManager.RideRequest request) {
        ...
        acceptBtn.addActionListener(e -> {
            if (RideManager.acceptRide(request.requestId, username)) {
                ...
                totalRidesCompleted++;
                rideCountLabel.setText(String.valueOf(totalRidesCompleted));
                updateStatus();
                JOptionPane.showMessageDialog(this, "Ride Accepted!");
                refreshRidesPanel();
            } else {
                JOptionPane.showMessageDialog(this, "Could not accept ride.");
            }
        });
